...
var entityrelist=["所有实体","鸡","牛","猪","羊","僵尸","苦力怕(爬行者)","骷髅射手","蜘蛛","僵尸猪人","矿车","掉落物品","点燃的TNT","掉落的方块","箭","雪球","鸡蛋","画"]
var entitylist=["鸡","牛","猪","羊","僵尸","苦力怕","骷髅射手","蜘蛛","僵尸猪人","矿车"]
...
var cat=[[CAT_STARTER_KIT_ITEMS,"全部物品"],[CAT_BUILDING_ITEMS,"建筑方块"],[ CAT_BUILDING_ITEMS,"0.9.5新增物品"],[CAT_ARMOUR_ITEMS,"好看方块"],[CAT_TOOLS_ITEMS,"工具与火车"],[ CAT_FOOD_ITEMS,"食物与染料"],]
...
var xc=new java.lang.Thread(new java.lang.Runnable({run:function(){
if(che==1){print2("上一个功能真的未完成,别问了")}else{
che++
cubi(x,y,z,i,id) 
...
if(swi==1){buttonk.setText("放置开关(开)")}
 ...
 buttonk.setOnClickListener(new android.view.View.OnClickListener({
  onClick:function(viewarg){
    ...
    swi=1;clientMessage("铁剑或铁桶桶或长按删除方块");}
    else if(swi==1)
...
if(fzfx==1){buttonx.setText("方向(Y)")}
 ...
 buttonx.setOnClickListener(new android.view.View.OnClickListener({
  onClick:function(viewarg){
    if(fzfx==1)
    {buttonx.setText("方向(左右)");
    fzfx=2}
    else if(fzfx==2)
    {buttonx.setText("方向(前后)");
    fzfx=3}    
    else if(fzfx==3)
    {buttonx.setText("方向(上下)");
    fzfx=1}
 }}))
...
layout.addView(s)
 ...
 button.setOnClickListener(new android.view.View.OnClickListener({
  onClick:function(viewarg){
    swifz=null
    clientMessage("点击两点，复制范围为长方体,铁剑或冰桶选择")
 }}))
 layout.addView(button)   
...
button.setOnClickListener(new android.view.View.OnClickListener({
  onClick:function(viewarg){
if(longgetchick==false){longgetchick=true;longget();print2("开启12格远距离模式");win3()}
...
if(isRunning){buttonss.setText("飞奔")}
 ...
 buttonss.setOnClickListener(new android.view.View.OnClickListener({
  onClick:function(viewarg){
    if(isRunning==false)
    {buttonss.setText("飞奔");isRunning=true;clientMessage("强劲奔跑")}
    else if(isRunning)
...
var s=new android.widget.TextView(ctx)
s.setTextSize(15)
s.setText("本页面要内容求在有限算法只能完成，否则会卡死，建议强度2000以下，在有限算法之内无论取多少都有问题")
s.setTextColor(android.graphics.Color.rgb(255,255,255));
s.setLayoutParams(textParams)
layout.addView(s)
...
var vs
add.setText("确认")
id.setHint("20满血，0为死亡不掉物品(生命值<=225)");
id.setText(null)
id.setInputType(number);
...
var s = new android.widget.TextView(ctx);  
s.setText("来自cp未经允许不不得转载，不得抄袭大量算法，欢迎交流算法\n如果有什么bug或者更好的想法请反馈给cp谢谢使用本js，如果不会用该js可以到地球查看\n铁剑和水贴可以当成空气，指南针可以查看方块，还可以让生物骑在生物上面\n“▲”是重复上一个功能，只能几何体，方块编辑，复制粘贴");
...
layout.addView(s)
 ...
 button.setOnClickListener(new android.view.View.OnClickListener({
  onClick:function(viewarg){
  crd=201
clientMessage("用Oak的木头点击方块生成相对应的树")
 }}))
 layout.addView(button)   
 ...
 button.setOnClickListener(new android.view.View.OnClickListener({
  onClick:function(viewarg){
  crd=205
  clientMessage("用Oak 的木头点击方块生成相对应的树")
 }}))
 layout.addView(button)   
...
clientMessage("指南针点击块块儿，获得块块儿数据")
m()
 }}))
 layout.addView(button)    
